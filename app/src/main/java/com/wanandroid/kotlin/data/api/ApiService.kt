...
import com.wanandroid.kotlin.data.repository.base.BaseResponse
...
interface ApiService {
    ...
    @FormUrlEncoded
    @POST("user/login")
    suspend fun login(@FieldMap paramsMap: @JvmSuppressWildcards Map<String, Any>): BaseResponse<UserBean>
    ...
    @FormUrlEncoded
    @POST("user/register")
    suspend fun register(@FieldMap paramsMap: @JvmSuppressWildcards Map<String, Any>): BaseResponse<UserBean>
